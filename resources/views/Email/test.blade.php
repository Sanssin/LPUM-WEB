                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                    align="left">
                                                                    <img class="w-24"
                                                                        src="{{ asset('assets/logo/Logo-lpum.png') }}"
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Halo, Selamat datang {{ $nama }} <br>
                                                                        Berikut adalah data akun yang bisa kamu gunakan
                                                                        untuk login pada website LPUM. <br>
                                                                        <b>Email</b> : admin@gmail.com <br>
                                                                        <b>Password</b> : sadfhrjd <br>
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                                                                                    ...
                                                                                    <a href="https://app.bootstrapemail.com/templates"
                                                                                        style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Coba
                                                                                        Login!</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                    ...
                                                    <div class="text-muted text-center" style="color: #718096;"
                                                        align="center">
                                                        Dikirim massal dari : <br>
                                                        Lembaga Pemilihan Umum Mahasiswa <br>
                                                        Poltek Nuklir
                                                    </div>
                                                    <table class="s-6 w-full" role="presentation" border="0"
                                                        cellpadding="0" cellspacing="0" style="width: 100%;"
